# Tempo — documenti pubblici

App: **Tempo**, orologio e meteo sulla schermata principale. Package `app.mindcontact.tempo`.

| Documento | Pagina | Sorgente |
|---|---|---|
| Pagina dell'app (IT) | [/](https://mindcontact.app/mcma-tempo/) | [`index.html`](index.html) |
